...
class MyTestCase(unittest.TestCase):
    ...
    def test_all_in_edges_of_node(self):
        ...
        d_graph.add_edge(22, 21, 2)
        self.assertEqual(2, len(d_graph.all_in_edges_of_node(21)))
        d_graph.remove_edge(20, 21)
        self.assertEqual(1, len(d_graph.all_in_edges_of_node(21)))
    ...
    def test_all_out_edges_of_node(self):
        ...
        d_graph.add_node(21)
        d_graph.add_node(22)
        d_graph.add_edge(20, 21, 5)
        d_graph.add_edge(20, 22, 8)
        self.assertEqual(2, len(d_graph.all_out_edges_of_node(20)))
        d_graph.add_edge(20, 21, 8)
        self.assertEqual(2, len(d_graph.all_out_edges_of_node(20)))
        d_graph.remove_edge(20, 21)
        d_graph.remove_edge(20, 21)
        self.assertEqual(1, len(d_graph.all_out_edges_of_node(20)))
    ...
    def test_get_mc(self):
        ...
        d_graph.add_node(17)
        self.assertEqual(12, d_graph.get_mc())
        d_graph.add_edge(1, 17, 2)
        d_graph.add_edge(1, 17, 5)
        self.assertEqual(13, d_graph.get_mc())
        d_graph.remove_node(17)
        self.assertEqual(15, d_graph.get_mc())
    ...
    def test_add_edge(self):
        ...
        d_graph.add_node(21)
        d_graph.add_node(22)
        self.assertTrue(d_graph.add_edge(20,21,5))
        self.assertFalse(d_graph.add_edge(20,21,42))
        self.assertTrue(d_graph.add_edge(20, 22, 6))
        self.assertTrue(d_graph.add_edge(21, 22, 62))
        self.assertFalse(d_graph.add_edge(20,20,31))
        self.assertFalse(d_graph.add_edge(21,22,3))
